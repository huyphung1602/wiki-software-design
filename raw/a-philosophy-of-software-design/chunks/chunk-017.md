...
16.2 Maintaining comments: keep the
...
longer accurate. Stale comments are frustrating to readers, and if there are
very many of them, readers begin to distrust all of the comments.
...
needed.
In languages with separate code and header files, such as C and C++,
an alternative is to place interface comments next to the method’s
...
16.3 Comments belong in the code, not the
commit log
...
16.4 Maintaining comments: avoid
duplication
...
16.6 Higher-level comments are easier to
maintain
